...
const About = () => {
    return (
        <div>
 <Helmet>
        <title>About | TraverseTask | Online Task Management Platform</title>
      </Helmet>
<div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div className="w-full lg:w-1/2">
            <div className="lg:max-w-lg">
                <h1 className="text-3xl font-semibold tracking-wide text-white lg:text-4xl">
                    Easiest way to manage your task with <span className="text-fuchsia-500">TraverseTask</span>
                </h1>

                <div className="mt-8 space-y-5">
                    <p className="flex items-center -mx-2 text-gray-200">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-fuchsia-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>

                        <span className="mx-2">Add Edit Delete Manage</span>
                    </p>
                    ...
                    <p className="flex items-center -mx-2 text-gray-200">
                        ...
                        <span className="mx-2">Just Drag & Drop</span>
                    </p>
            ...
            <div className="w-full mt-8 bg-transparent border rounded-md lg:max-w-sm border-white focus-within:ring focus-within:ring-fuchsia-300 focus-within:border-fuchsia-400 focus-within:ring-opacity-40">
                <form className="flex flex-col lg:flex-row">
                    <input type="email" placeholder="Enter your email to all updates" className="flex-1 h-10 px-4 py-2 m-1 text-white placeholder-gray-400 bg-transparent border-none appearance-none  focus:outline-none focus:placeholder-transparent focus:ring-0" />

                    <button type="button" className="h-10 px-4 py-2 m-1 text-white transition-colors duration-300 transform bg-fuchsia-500 rounded-md hover:bg-fuchsia-400 focus:outline-none focus:bg-fuchsia-400">
                        Join Us
                    </button>
                </form>
            </div>
        ...
        <div className="flex items-center justify-center w-full h-96 lg:w-1/2">
            <img className="object-cover w-full h-full mx-auto rounded-md lg:max-w-2xl" src="https://i.ibb.co/dfNBSw6/image.png" alt="glasses photo"/>
        </div>
    </div>
    ...
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-center capitalize lg:text-4xl text-white">Our <span className='text-fuchsia-600'>Sponsor Partner</span> Who Happily Satisfy </h1>
    ...
    <section className="bg-black">
    <div className="container px-6 py-10 mx-auto">
        <h1 className="text-2xl font-semibold text-center capitalize lg:text-4xl text-white">Our <span className='text-fuchsia-600'>Top Client</span> Who Happily Satisfy </h1>



        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/SxcyWcW/download.jpg" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Jhankar Mahabub</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">CEO, Programming Hero</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/3SscnDj/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Shahriar Ahmed</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">CEO, Offcarry & Finepay</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/7RPqfZ7/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Sumit Shah</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">Founder,LWS & Analyzen</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/QXY2Pwb/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Hasin Hayder</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">CEO, Learn With HH</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/hRP7ckh/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Anisul Islam</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">Full Stack Developer</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/2PByYD3/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Imran Ali Dina</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">Graphics Designer</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/0scZhr6/image.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Ayman Sadiq</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">Founder, 10 MS School</p>

          
            </div>

            <div className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-fuchsia-600 rounded-xl">
                <img className="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://i.ibb.co/frPGLcQ/33.png" alt=""/>

                <h1 className="mt-4 text-2xl font-semibold text-white capitalize  group-hover:text-white">Sahoss Khan</h1>

                <p className="mt-2 capitalize text-white group-hover:text-gray-300">Content Creator</p>
